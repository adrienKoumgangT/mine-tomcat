package com.github.adrien.koumgang.minetomcat.helpers.filter.server;
...
public class MyInterceptor implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    public void filter(ContainerRequestContext request) throws IOException {
        ...
        request.setProperty(ServerUtils.RAW_BODY_PROP, new String(bodyBytes, StandardCharsets.UTF_8));
